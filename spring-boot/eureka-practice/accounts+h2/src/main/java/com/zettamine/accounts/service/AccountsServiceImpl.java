...
import com.zettamine.accounts.CardsFeignClient;
import com.zettamine.accounts.LoansFeignCLient;
...
//@ConditionalOnBean(name = {"CardsFeignClient","LoansFeignCLient"})
public class AccountsServiceImpl  implements IAccountsService {
    ...
    @Override
    public CustomerDetailsDto getAllDetails(String mobileNumber) {
    	CustomerDetailsDto dto = new CustomerDetailsDto();
         ...
         dto.setCardsDto(cardsFeignClient.fetchCardDetails(mobileNumber).getBody());
         dto.setLoansDto(loansFeignCLient.fetchLoanDetails(mobileNumber).getBody());
         return dto;
    }
