...
//    @CircuitBreaker(name = "accountsCIrcuitBreaker", fallbackMethod = "getContactInfoCallBack")
    @RateLimiter(name = "rateLimiter", fallbackMethod ="getContactInfoCallBack" )
    ...
    public ResponseEntity<AccountsContactInfoDto> getContactInfoCallBack(Throwable t) {
        return ResponseEntity
        		.status(HttpStatus.TOO_MANY_REQUESTS)
                .body(new AccountsContactInfoDto(null, null, null));
    }
    
    @GetMapping("/customer-details")
	public ResponseEntity<CustomerDetailsDto> getAllDetails(@RequestParam String mobileNumber){
		return ResponseEntity.status(HttpStatus.OK)
				             .body(iAccountsService.getAllDetails(mobileNumber));
	}
